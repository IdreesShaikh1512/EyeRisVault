...
class IrisBiometricEngine:
    ...
    def __init__(self, encryption_key=None):
        ...
        self.encryption_key = encryption_key or os.environ.get('BIOMETRIC_KEY', 'default_key_32bytes_change_me_in_production_please')
        if len(self.encryption_key) < 32:
            # Pad or hash to ensure at least 32 bytes
            self.encryption_key = (self.encryption_key * 3)[:32]
