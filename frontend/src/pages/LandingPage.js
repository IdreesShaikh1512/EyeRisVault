...
const LandingPage = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-blue-950 text-white relative overflow-hidden">
      ...
      {/* Header */}
      <header className="relative z-10 px-4 sm:px-8 py-4 sm:py-6 flex justify-between items-center">
        <div className="flex items-center space-x-2 sm:space-x-3">
          ...
          <h1 className="text-xl sm:text-2xl font-bold" data-testid="logo">IRISVAULT</h1>
        </div>
        <Button 
          variant="ghost" 
      ...
      {/* Hero Section */}
      <main className="relative z-10 container mx-auto px-4 sm:px-8 py-12 sm:py-20">
